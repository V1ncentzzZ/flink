...
public class HttpUtils {
    ...
    public static HttpPost wrapPostRequest(
            String requestUrl,
            Map<String, String> requestHeaders,
            List<String> requestParams,
            List<Object> requestParamValues)
            throws IOException {
    ...
    public static HttpGet wrapGetRequest(
            String requestUrl,
            Map<String, String> requestHeaders,
            List<String> requestParams,
            List<Object> requestParamValues)
        ...
        for (int i = 0; i < requestParamValues.size(); i++) {
            uriBuilder.addParameter(
                    requestParams.get(i), String.valueOf(requestParamValues.get(i)));
        }
