...
import org.apache.flink.MoreRunnables;
import org.apache.flink.MoreSuppliers;
...
public class ProtobufRowFormatFactory extends TableFormatFactoryBase<Row>
    ...
    protected List<String> supportedFormatProperties() {
        ...
        properties.add(ProtobufValidator.FORMAT_MESSAGE_CLASS);
    ...
    public DeserializationSchema<Row> createDeserializationSchema(Map<String, String> properties) {
		...
		TypeInformation<Row> typeInfo = deriveSchema(descriptorProperties.asMap()).toRowType();

		// create and configure
		ProtobufRowDeserializationSchema schema = new ProtobufRowDeserializationSchema(
			descriptorProperties.getClass(ProtobufValidator.FORMAT_MESSAGE_CLASS, GeneratedMessageV3.class),
			typeInfo,
			tableSchema,
			descriptorProperties.containsKey(ProtobufValidator.FORMAT_IGNORE_PARSE_ERRORS)
				&& descriptorProperties.getBoolean(ProtobufValidator.FORMAT_IGNORE_PARSE_ERRORS));
		return schema;
	}
